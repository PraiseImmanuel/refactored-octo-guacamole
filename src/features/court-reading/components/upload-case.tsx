    ...
    <>
      ...
      >
        ...
        <div className="flex items-center">
          <input
            type="file"
            className="w-full border-2 py-2.5 px-4 mt-2 rounded-md mr-4 outline-none border-[#222]/40
        ...
        <div className="">
          ...
          <input
            type="text"
            className="w-full border-2 py-3.5 px-4 mt-2 rounded-md mr-4 outline-none focus:border-[#222]/50 
        ...
        {uploadedFiles.length !== 0 && (
          <button
            className="bg-[#111] bg-opacity-85 text-white px-10 py-2.5 rounded-lg mx-auto
              flex hover:opacity-70 transition-all duration-200 font-[600] mt-4"
